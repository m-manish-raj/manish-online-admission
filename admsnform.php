     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/parul.jpg" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <table class="frmtbl">
                ...
                <tr border="1" class="hdrow">
                  ...
                  <tr>
                          <td> <font style="font-family: Verdana;"><h2><?php echo $stname;?></h2> </font> </td>
                    <td colspan="2"> 
               ...
               <tr>
                     ...
                     <td><select id="col" name="col">
                         <option>--------------------Select--------------------</option>
                         <option>Parul instute of Computer Application</option>
                         <option>Parul instute of Engineering</option>
                         </select>
                     </td>
                ...
                <tr>
                     <td><font style="font-family: Verdana;">% in PCM/MCA</font></td>
